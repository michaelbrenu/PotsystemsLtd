...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent = `
      ...
      #cookie-text p { font-size: .7rem; color: rgba(255,255,255,.6); margin-top: 0; line-height: 1.2; }
      ...
      .cookie-btn-outline {
        ...
        border: 1px solid rgba(255,255,255,.35); padding: 4px 10px; border-radius: 4px;
